    ...
    <div className="flex flex-col h-full w-full justify-between p-6">
      <div className="flex gap-4">
        ...
        <div className="flex flex-col justify-center gap-0.5 min-w-0">
          <span className="text-base font-bold truncate text-background leading-tight">
            Starboy
          </span>
          <span className="text-xs text-background/60 truncate font-medium">
            The Weeknd
          </span>
      ...
      <div className="flex items-center justify-between w-full mt-2 px-2">
        ...
        <div className="flex items-center gap-6 text-background">
          ...
          <Play
            size={32}
            className="fill-current cursor-pointer hover:scale-110 transition-transform"
          />
          <SkipForward
            size={24}
            className="cursor-pointer opacity-70 hover:opacity-100"

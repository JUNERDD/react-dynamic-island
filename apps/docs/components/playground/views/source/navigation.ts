export const navigationViewSource = `import { Navigation, ArrowUpRight } from 'lucide-react'
    ...
    <div className="flex h-full w-full items-center px-6 gap-6">
      <div className="flex-1 flex flex-col justify-center">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xl font-bold text-background leading-none">200m</span>
        </div>
        <span className="text-sm font-medium text-background/60 truncate">Turn right onto Market St</span>
      </div>

export const callViewSource = `import { Phone, MicOff, Video } from 'lucide-react'
    ...
    <div className="flex h-full w-full items-center justify-between px-2">
      <div className="flex items-center gap-2 bg-white/10 pr-3 rounded-full p-1">
        ...
        <div className="flex flex-col justify-center min-w-[40px]">
          <span className="text-sm font-bold leading-none text-background">John</span>
          <div className="flex items-center gap-1 mt-0.5">
             ...
             <span className="text-[10px] text-green-400 font-mono leading-none">04:20</span>
          </div>
        </div>
      </div>
